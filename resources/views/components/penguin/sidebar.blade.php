    <nav x-cloak
        ...
        <a href="#" class="ml-2 text-2xl font-bold w-fit text-neutral-900 dark:text-zinc-50">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 376 155" fill="none" class="w-24" aria-hidden="true">
                <path
                    ...
                    class="fill-neutral-900 dark:fill-zinc-50"></path>
                <path
                    ...
                    class="fill-sky-700 dark:fill-sky-600"></path>
                <g>
                    <path
        ...
        <div class="relative flex flex-col w-full max-w-xs gap-1 my-4 text-neutral-600 dark:text-zinc-200">
            ...
            <input type="search"
                class="w-full border border-zinc-300 rounded bg-zinc-50 px-2 py-1.5 pl-9 text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700 disabled:cursor-not-allowed disabled:opacity-75 dark:border-zinc-700 dark:bg-zinc-900/50 dark:focus-visible:outline-sky-600"
        ...
        <div class="flex flex-col gap-2 pb-6 overflow-y-auto">
            ...
            <a wire:navigate href="{{ route('dashboard') }}"
                class="flex items-center rounded gap-2 px-2 py-1.5 text-sm font-medium text-neutral-600 underline-offset-2 hover:bg-sky-700/5 hover:text-neutral-900 focus-visible:underline focus:outline-none dark:text-zinc-200 dark:hover:bg-sky-600/5 dark:hover:text-zinc-50
                        @if (Route::is('dashboard')) {{ 'bg-sky-700/10' }} @endif"
            ...
            <!-- collapsible item  -->
            <div x-data="{ isExpanded: {{ in_array(Request::segment(1), ['user-management']) ? 'true' : 'false' }} }" class="flex flex-col">
                <button type="button" x-on:click="isExpanded = ! isExpanded" id="user-management-btn"
                    ...
                    class="flex items-center justify-between rounded gap-2 px-2 py-1.5 text-sm font-medium underline-offset-2 focus:outline-none focus-visible:underline"
                    x-bind:class="isExpanded ? 'text-neutral-900 bg-sky-700/10 dark:text-zinc-50 dark:bg-sky-600/10' :
                        'text-neutral-600 hover:bg-sky-700/5 hover:text-neutral-900 dark:text-zinc-200 dark:hover:text-zinc-50 dark:hover:bg-sky-600/5'">
                ...
                <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="user-management-btn" id="user-management"
                    ...
                    <li class="px-1 py-0.5 first:mt-2">
                        <a wire:navigate href="{{ route('user-management.users.index') }}"
                            ...
                            @if (Route::is('user-management.users.index')) {{ 'bg-sky-700/10' }} @endif">Users</a>
                    </li>
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-sky-700/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-zinc-200 dark:hover:bg-sky-600/5 dark:hover:text-zinc-50">Permissions</a>
                    </li>
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
            ...
            <div x-data="{ isExpanded: false }" class="flex flex-col">
                ...
                <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="products-btn" id="products">
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-sky-700/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-zinc-200 dark:hover:bg-sky-600/5 dark:hover:text-zinc-50">All
                            Products</a>
                    </li>
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-sky-700/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-zinc-200 dark:hover:bg-sky-600/5 dark:hover:text-zinc-50">Inventory</a>
                    </li>
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-sky-700/5 hover:text-neutral-900 focus:outline-none focus-visible:underline dark:text-zinc-200 dark:hover:bg-sky-600/5 dark:hover:text-zinc-50">Reviews</a>
                    </li>
                </ul>
            </div>
