{{-- <div class="rounded-lg p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
    @section('title')
        {{ $title }}
    @endsection
    <div class="flex flex-row justify-between w-full gap-2 py-3 items-top">
    ...
    <div class="items-center w-full overflow-hidden overflow-x-auto border rounded border-zinc-300 dark:border-zinc-700">
...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        @section('title')
            {{ $title }}
        @endsection
        <div class="flex flex-row justify-between w-full gap-2 px-4 py-3 items-top">
                <div class="flex flex-row items-center mb-3 space-x-4">
                    <label class="text-sm font-medium text-gray-900 w-14 dark:text-white">Per Hal</label>
                    <select wire:model.live='perPage'
                        class="block text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="items-center w-full overflow-hidden overflow-x-auto border border-zinc-300 dark:border-zinc-700">
            <table class="w-full text-sm text-left text-neutral-600 dark:text-zinc-200">
                <thead class="text-sm border-b border-zinc-300 bg-zinc-100 text-neutral-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50">
                    <tr>
                        <th scope="col" class="p-4">#</th>
